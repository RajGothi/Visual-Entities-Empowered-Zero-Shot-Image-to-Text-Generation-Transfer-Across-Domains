...
def entity_extraction(captions: List[str], path: str) -> None:
    ...
    for caption in captions:
        detected_entities = []
        pos_tags = nltk.pos_tag(nltk.word_tokenize(caption)) # [('person': 'NN'), ...]
...
if __name__ == '__main__':
    ...
    if os.path.exists(out_path[idx]):
        ...
        entity_extraction(captions, out_path[idx])