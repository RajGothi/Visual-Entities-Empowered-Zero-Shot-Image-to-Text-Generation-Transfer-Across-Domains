...
from utils.utils import noise_injection
from CaptionsDataset import collate
from torch.utils.data import DataLoader
from CaptionsDataset import CaptionsDataset
from Model.ClipCap import ClipCaptionModel, ClipCaptionPrefix
...
def main():
    ...
    parser.add_argument('--language_model', default = 'gpt2', help = 'gpt2')
