...
@torch.no_grad()
def feature_extraction(device: str, clip_type: str, inpath: str, outpath: str):
...
if __name__ == '__main__':
    ...
    if os.path.exists(outpath[idx]):
        ...
        captions_with_features = feature_extraction(device, clip_type, inpath[idx], outpath[idx])
